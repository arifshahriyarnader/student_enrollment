      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            ...
            <div class="details">
              <p class="user-name">Arif Shahriyar Nader</p>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="layoutsSubmenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/tution')}}">Tution Fee</a>
                  </li>
                  <li class="nav-item">
         ...
         <!--   <li class="nav-item">
             ...
             <i class="mdi mdi-repeat menu-icon"></i>
               ...
               <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/cse')}}">Add Teacher</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/eee')}}">All Teacher</a>
                  </li> 
                   </ul>
              </div>
               </li> -->
